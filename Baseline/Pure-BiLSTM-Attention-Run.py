...
wandb.init(
    ...
    name="Pure-BiLSTM-Attention-Run",
    config={
        "architecture": "Pure BiLSTM + Attention",
...
print("3. Xây dựng Từ điển và Padding...")
...
# ==========================================
# 4. KIẾN TRÚC MẠNG PURE BiLSTM + ATTENTION
# ==========================================
print("4. Khởi tạo kiến trúc mạng BiLSTM kết hợp Attention (Không dùng CNN)...")
...
class PureBiLSTMAttention(nn.Module):
    def __init__(self):
        super(PureBiLSTMAttention, self).__init__()
        ...
        self.lstm = nn.LSTM(input_size=EMBEDDING_DIM, 
                            ...
                            bidirectional=True, 
                            batch_first=True)
        self.attention = AttentionLayer(hidden_dim=128)
...
model = PureBiLSTMAttention().to(device)
...
# Theo dõi Gradients của mạng BiLSTM + Attention
...
print(f"\n|=== KẾT QUẢ ĐÁNH GIÁ PURE BiLSTM + ATTENTION ===|")
